...
if(isset($_POST['btn-login']))
{
	...
	{
		$error = "Password o utente non coretto";
	}	
}
?>
...
<div id="error">
	...
	?>
			...
			<div class="form-group">
				<input type="text" class="form-control" name="txt_uname_email" placeholder="Nome e Cognome" required="" id="username" />
			</div>
			...
			<div class="form-group">
				<input type="submit" name="btn-login" value="Accedi" id="login" />
				<?php if (config::get('allow_signup')):?>
				<a href="signup.php"><b>Registrati</b></a>
				<?php endif;?>
			</div>
		</form>
		<div class="button">
