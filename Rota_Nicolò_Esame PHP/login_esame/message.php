...
<head>
	<meta charset="UTF-8">
	<title>PhpPasswordProtect</title>
		...
		<div class="container" id="container">
			<div class="overlay-container">
				...
				<div class="overlay-panel overlay-right">
					...
					You will be redirected to login page in <span id="counter">3</span> second(s).</p>
				</div>
				</div>
			</div>
		</div>
...
<style type="text/css">
	...
	* {
	...
	.overlay {
		background: #FF416C;
		background: -webkit-linear-gradient(to right, #00b4d8, #4150ff);
		background: linear-gradient(to right, #00b4d8, #4150ff);
